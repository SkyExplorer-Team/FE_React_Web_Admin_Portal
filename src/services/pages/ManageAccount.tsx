  ...
  const handleDeleteUser = async (e: { preventDefault: () => void }) => {
    ...
    try {
      const response = await fetch(
        `${domainApi}/api/v1/users/${infoDeleteData.id}`,
        {
          method: "DELETE",
          headers: {
        ...
        <>
          ...
          <Button
            ...
            onClick={() => {
              ...
              setInfoDeleteData({ id: row.id, name: row.name });
            }}
          >
          ...
          <Card.Body className="p-4">
            ...
            <div className="row my-3 align-items-center">
              ...
              <div className="col text-end">
                <Link to={"/account/add"}>
                  <Button variant="primary" className="primary-button-small">
                    Tambah User
                  </Button>
                </Link>
              </div>
